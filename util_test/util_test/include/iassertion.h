...
typedef enum {TAK_NUM=0,TAK_MEM,TAK_BOOL,TAK_MAX=TAK_BOOL}TAKind;
...
TAOperator TA_num_getAssertion(const TestAssertion *self);
...
TAOperator TA_mem_getAssertion(const TestAssertion *self);
